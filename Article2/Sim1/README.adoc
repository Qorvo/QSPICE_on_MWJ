...
This LDO is designed to have 5V output from its 0.5V reference voltage (VREF), so it's a "Å~10" amplifier from the view point of the VREF.

By thinking it as a "Å~10" amplifier of VREF, the AC simulation source "Vac" is placed to the VREF in series.
